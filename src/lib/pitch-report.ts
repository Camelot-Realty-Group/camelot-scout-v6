...
import { buildDavidGoldoffSignatureHtml, DAVID_GOLDOFF_SIGNATURE_TEXT } from './camelot-signature';
...
function davidGoldoffClientSignatureHtml(): string {
  return `<div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:12px;color:#1a2744;line-height:1.7"><strong>Sincerely yours,</strong>${buildDavidGoldoffSignatureHtml({ includeImage: true })}</div>`;
}
