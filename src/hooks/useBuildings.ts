...
const DEMO_BUILDINGS: Building[] = [
  {
    id: '1',
    address: '201 East 79th Street',
    name: '201 East 79th Street Tenants Corp.',
    borough: 'Manhattan',
    ...
    grade: 'A',
    score: 82,
    signals: ['Known co-op profile', 'Large staffed building', 'Management verified: FirstService Residential'],
    contacts: [
      {
        name: 'Margaret Chen',
