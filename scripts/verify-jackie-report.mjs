...
const requiredTokens = [
  ...
  ['Jackie HQ route map source', 'Embedded Google Maps route'],
  ['Jackie intro embedded street view fallback', 'embedded Google Street View fallback'],
  ...
  ['Jackie subject image visual fallback', 'image or Google Street View fallback'],
